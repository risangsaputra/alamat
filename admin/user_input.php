          ...
          <div class="box box-primary">
            ...
            <form role="form" action="user_simpan.php" method="POST" enctype="multipart/form-data">
              ...
              <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="nama" id="exampleInputName" placeholder="Masukkan Nama">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <input type="password" class="form-control" name="password2" id="exampleInputPassword1" placeholder="Re-Password">
                </div>
                <div class="form-group">
